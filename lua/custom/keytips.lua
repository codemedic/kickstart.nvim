...
local tips = {
  ...
  { category = 'LSP', keys = '<C-g>  /  <C-LeftMouse>', desc = 'Smart navigate: jump to definition from a usage; on a declaration, jump to the one project reference or open the full list' },
